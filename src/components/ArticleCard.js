  ...
  return (
    <article className="shadow rounded-lg flex flex-col flex-shrink-0 w-[400px] md:w-[500px] xl:w-[700px] snap-center cursor-pointer transition-opacity duration-200 overflow-hidden">
      ...
      <div className="flex flex-col p-4">
        ...
        <button class="group relative h-12 w-40 overflow-hidden rounded-lg bg-white text-sm shadow mt-8 self-end tracking-widest uppercase">
          <div class="absolute inset-0 w-3 bg-[#292929] transition-all duration-[250ms] ease-out group-hover:w-full"></div>
